    ...
    {    
      switch (demo_id)
      {
        ...
        case 6:
          ...
          break;
        case 7:
          if ((hex_id==0) || (hex_id==6))
          {
            hexRGB.line(hex_id, CRGB::Yellow, (i_3+1)/2);
          }
          if (hex_id==3)
          {
            hexRGB.line(hex_id, CRGB::Red, (i_3+1)/2);
          }          
          break;                   
        default:                  
          break;     
    ...
    #endif
    {
        ...
        else
        {
          for (int hex_id=0; hex_id<NUM_HEX; hex_id ++)
          {
            ...
            if ((hex_id+1)%3==0)
            {
              hexRGB.color(hex_id, CRGB::Green);  
            }
            if ((hex_id+2)%3==0)
            {
              hexRGB.color(hex_id, CRGB::Blue);  
            }                                    
          }
          hexRGB.color(3, CRGB::Yellow);         
        }      
    }    
  }     
}
